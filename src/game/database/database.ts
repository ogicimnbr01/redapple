...
export const ADJACENCY_GRAPH: Record<string, string[]> = {
  ...
  "genoa_sardinia": ["siena", "naples_sardinia", "rome"],
  "genoa": ["milan", "ferrara", "florence", "savoy", "switzerland"],
...
export const INITIAL_PROVINCES: Record<string, Province> = {
  ...
  "genoa_sardinia": {
    ...
    "religion": "Catholic",
    "terrain": "Hills",
    "adjacentProvinces": ["siena", "naples_sardinia", "rome"],
  ...
  "genoa": {
    ...
    "religion": "Catholic",
    "terrain": "Hills",
    "adjacentProvinces": ["milan", "ferrara", "florence", "savoy", "switzerland"],
